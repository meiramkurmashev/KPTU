...
#pragma warning restore CS0618 // Тип или член устарел
            ...
            while (!Eof)
            {
                ...
                //string.IsNullOrWhiteSpace(name) ? (object)DBNull.Value : (string)dtr["NAME"]; 
...
#pragma warning restore CS0618 // Тип или член устарел
        ...
        {
            string sql1 = "UPDATE TURNTABLES SET NAME = '" + name + "' WHERE ID = " + id + "";
...
#pragma warning restore CS0618 // Тип или член устарел
        ...
        {
            string sql2 = "DELETE TURNTABLES WHERE ID = " + id + "";
...
#pragma warning restore CS0618 // Тип или член устарел
        ...
        {
            string sql1 = "INSERT INTO TURNTABLES ( ID, NAME) VALUES('" + id + "','" + name + "')";
#pragma warning disable CS0618 // Тип или член устарел
#pragma warning disable CS0618 // Тип или член устарел
            OracleCommand cmd = new OracleCommand();
#pragma warning restore CS0618 // Тип или член устарел
